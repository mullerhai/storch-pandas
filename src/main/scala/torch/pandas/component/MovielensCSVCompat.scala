...
import torch.csv.{CSVFormat, CSVReader, Quoting, QUOTE_MINIMAL}
...
object RatingCSVCompat {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = RatingCSVCompat.readCSV("D:\\data\\git\\testNumpy\\src\\main\\resources\\ml-1m\\ratings.dat",header)
    df.heads(1000).show()
  }
  ...
  def readCSV(csvPath: String, header: Seq[String] = null,limit: Int = -1): DataFrame[AnyRef] = {
